 ...
 *
 * A plain current-SPI driver whose create method captures per-instance
 * settings, environment, adapter, text generation, snapshot, and maintenance.
 *
...
/** Package-manager maintenance seam for OMP. */
